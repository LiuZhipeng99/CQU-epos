...
#define SYSCALL_time          2020//添加得系统调用码
#define SYSCALL_sem_create    2030
#define SYSCALL_sem_destroy   2031
#define	SYSCALL_sem_wait      2032
#define SYSCALL_sem_signal	  2033
#endif /*_SYSCALLNR_H*/
